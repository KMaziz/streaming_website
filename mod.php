...
<input type="hidden" name="id" value="<?php echo($id) ;?>">
  ...
  //affichage des données:
     ...
     ?>
                  ...
                  <input type="radio" name="role" selected="selected" value="<?php echo ($data1->ID_ROLE); ?>"><?php echo ($data1->NOM_ROLE); ?>
<?php
                    }
                  ?>
                  </td>
                  <td><input type="text" name="prenom" value="<?php echo ($data->PRENOM); ?>"></td>
                  <td><input type="email" name="mail" value="<?php echo ($data->MAIL); ?>"></td>
