...
<a href="#" title="Tous les films en Streaming">Tous les films en Streaming</a>
   ...
   {$id=$_GET['id'];
// Create connection
$sql0="SELECT count(ID_VIDEO) as nbArt from video where ID_GENRE='$id' ";
$req0=mysqli_query($conn,$sql0);
$data0=mysqli_fetch_assoc($req0);
...
else
{
    $cPage=1;
                  ...
                  $sq1="SELECT * FROM video   where  ID_GENRE='$id' and ID_CATEGORIE<>'1' ORDER BY DATE_SORTIE DESC LIMIT ".(($cPage-1)*$perPage).",$perPage";
...
{
 ?>
<div class="col-lg-1 col-sm-2 col-xs-2 pages-prev"><a href=<?php echo "genre_serie.php?p=".($cPage-1); ?>><i class="fa fa-angle-left"></i><b>Précédente</b></a>
</div>
<?php
}
?>
...
for($j=1;$j<=$nbPage;$j++)
    {if($j==$cPage)
        {   echo $j;
            ...
            {
?>
<a href=<?php echo "genre_serie.php?p=$j"; ?> ><?php echo $j; ?> </a>
...
{
 ?>
  <div class="col-lg-1 col-sm-2 col-xs-2 pages-next"><a href=<?php echo "genre_serie.php?p=".($cPage+1); ?>><i class="fa fa-angle-right"></i><b>Suivante</b></a></div>
<?php
}
?>
</div>
