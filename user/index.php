...
<li><a href="../home/logout.php" title="Inscription sur le site" class="nav-login-user radius-5">LOG OUT</a></li>
</ul></div>
...
<h1 class="h-owl h-owl-big"><b>Films 2018</b></h1>
<div class="owl-box">

<div id="owl-slider" class="owl-carousel">
<?php
$sq="SELECT * FROM video where ANNE_PRODUCTION='2018'";
$rqq=mysqli_query($conn,$sq);
while($row=mysqli_fetch_assoc($rqq))
{
...
<a href="<?php echo "films/films.php?id=".$row['ID_VIDEO']; ?>" title=<?php echo $row['TITRE']."Streaming VF"; ?> class="short-images-link">
<img src="<?php echo $row['LIEN_IMAGE']; ?>" alt="Wind River" title=<?php echo $row['TITRE']."Streaming VF"; ?>/>
</a>
s
</div>
<div class="short-content">
<h4 class="short-link"><a href="<?php echo "films/films.php?id=".$row['ID_VIDEO']; ?>" title="<?php echo $row['TITRE']."Streaming VF"; ?> "><?php echo $row['TITRE']; ?></a></h4>
<div class="short-rating">
<div id='ratig-layer-8557'>
<div class="rating">
