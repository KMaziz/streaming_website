...
$sql0="INSERT INTO contact VALUES('','$nom','$prenom','$email','$sujet','$message')";

if(mysqli_query($conn,$sql0))

    echo "modifications avec succes";
    else
...
<a href="index.html" itemprop="url"><span itemprop="title">Papstream</span></a></span> » Contactez nous</span>
</div>

<div id="dle-content"><form method="post" id="sendmail" name="sendmail" action="">
<div id="page-input">
<h1 class="h-page">Contactez-nous</h1>
<div class="blockquote">
<p><b>Bonjour, chers visiteurs! </b> <br> <br>
Contactez nous pour des informations sur le site, services ou conseillers et de vos suggestions. Notre équipe s'engage à répondre à votre demande dans les plus brefs délais.<br>
Merci d'avoir choisi notre site!</p>
</div>
...
<input type="text" maxlength="35" name="nom" class="igroup-input" placeholder="Votre nom">
</div>
<div class="igroup">
<span class="igroup-span"><i class="fa fa-user"></i></span>
<input type="text" maxlength="35" name="prenom" class="igroup-input" placeholder="Votre prenom">
</div>
<div class="igroup">
<span class="igroup-span"><i class="fa fa-at"></i></span>
<input type="text" maxlength="35" name="email" class="igroup-input" placeholder="Votre E-Mail">
</div>

<div class="igroup">
<span class="igroup-span"><i class="fa fa-file-text-o"></i></span>
<input type="text" maxlength="45" name="sujet" class="igroup-input" placeholder="Sujet">
</div>
<div class="igroup">
<span class="igroup-span"><i class="fa fa-pencil-square-o"></i></span>
<textarea name="message" class="igroup-input" rows="5" placeholder="Message..."></textarea>
</div>
<script src="../www.google.com/recaptcha/api.js" async defer></script>
<div class="com-captcha" style="float: left;    margin: 12px 23% 17px 10px;">
<div class="g-recaptcha" data-sitekey="6Lf6QykUAAAAAFMm29SusZ-EK-TMOw4JXyVOyUGY"></div>
</div>
<div class="clearfix" style="    margin: 0 0 0px 5px;"></div>
<div class="fieldsubmit igroup" style="margin: 0px 0 0; ">
