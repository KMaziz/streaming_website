...
<a class="logotype" href="index.html"><img src="templates/default/images/logo.png" alt="http://www.papstream.net" /></a>
</div>
...
<?php
   $NOM_CATEGORIE=$data['NOM_CATEGORIE'];
             $sql1="SELECT g.ID_GENRE ,g.NOM_GENRE,c.ID_CATEGORIE FROM  genre as g , categorie as c  WHERE g.ID_CATEGORIE=c.ID_CATEGORIE AND c.NOM_CATEGORIE='$NOM_CATEGORIE'";
                $rq1=mysqli_query($conn,$sql1);
                
                while($ligne=mysqli_fetch_assoc($rq1))
                { ?>
<li><a href=<?php echo "genre.php?id=".$ligne['ID_GENRE']; ?> title="Comédie » Film Streaming"><?php echo $ligne['NOM_GENRE']; ?></a></li>
<?php } ?>
</ul>
</li>
<?php
...
<form action="http://www.papstream.net/rechercher" name="searchform" method="post">
...
<ul class="nav-info">
<li data-toggle="tooltip" data-placement="bottom" data-original-title="Derniers ajoutés" title="Derniers ajoutés">
<a href="demande.php">
...
{
 ?>
<div class="col-lg-1 col-sm-2 col-xs-2 pages-prev"><a href=<?php echo "serie.php?p=".($cPage-1); ?>><i class="fa fa-angle-left"></i><b>Précédente</b></a>
</div>
<?php
}
?>
...
for($j=1;$j<=$nbPage;$j++)
    {if($j==$cPage)
        {   echo $j;
            ...
            {
?>
<a href=<?php echo "serie.php?p=$j"; ?> ><?php echo $j; ?> </a>
...
{
 ?>
  <div class="col-lg-1 col-sm-2 col-xs-2 pages-next"><a href=<?php echo "serie.php?p=".($cPage+1); ?>><i class="fa fa-angle-right"></i><b>Suivante</b></a></div>
<?php
}
?>
</div>
...
</div></div></div></div></div></div></div></div><div class="container"><div class="col-md-9 col-xs-12"></div></div><br /><div id="cinema_overlay"><i id="cinema_close" class="fa fa-times-circle"></i></div><div id="footer"><div class="container"><div class="row"><div class="col-md-3 col-xs-12">
<p class="footer-description"><a class="logotype" href="index.html" title="">
<img src="templates/default/images/logo.png" class="footer-logo" alt="" />
</a></p></div><div class="col-md-6 col-xs-12"></div></div></div><div id="copirating">
<div class="container"><p class="copirating">
<i class="fa fa-copyright fa-lg"></i> Film streaming gratuit HD en VF et VOSTFR, série et manga streaming - Le site contient un certain nombre de liens hypertextes vers d’autres sites, et n’a pas la possibilité de vérifier le contenu des sites ainsi visités, et n’assumera en conséquence aucune responsabilité de ce fait&nbsp;&nbsp;<a href="dmca.html" title="DMCA">DMCA</a> | <a href="https://www.google.com/#q=papstream.net" title="Papstream sur google" target="_blank">Papstream sur google</a></p></div></div>
</div>
