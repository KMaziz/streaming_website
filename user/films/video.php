...
<?php
 ...
 <li class=<?php echo " nav".$i ; ?> ><a href="films/video.php" title="<?php echo $data['NOM_CATEGORIE']; ?> Streaming"><?php echo $data['NOM_CATEGORIE'] ; ?></a></li>
...
<?php
   $NOM_CATEGORIE=$data['NOM_CATEGORIE'];
             $sql1="SELECT g.ID_GENRE ,g.NOM_GENRE,c.ID_CATEGORIE FROM  genre as g , categorie as c  WHERE g.ID_CATEGORIE=c.ID_CATEGORIE AND c.NOM_CATEGORIE='$NOM_CATEGORIE'";
                ...
                { ?>
<li><a href="#g" title="Comédie » Film Streaming"><?php echo $ligne['NOM_GENRE']; ?></a></li>
<?php } ?>
</ul>
</li>
<?php
...
<!-- ****************************************** -->
 <div class="margin-b20"></div><div class="fb-page" data-href="https://www.facebook.com/PapStreamCoM-202250520219907" data-small-header="false" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true"></div>
</div></div></div></div></div></div><div class="container"><div class="col-md-9 col-xs-12"></div></div><br /><div id="cinema_overlay"><i id="cinema_close" class="fa fa-times-circle"></i></div><div id="footer"><div class="container"><div class="row"><div class="col-md-3 col-xs-12">
<p class="footer-description"><a class="logotype" href="index.php" title="">
