...
<!DOCTYPE html>
<html>
<link rel="dns-prefetch" href="http://www.papstream.net/films/https//ajax.googleapis.com/">
<link rel="dns-prefetch" href="https://www.facebook.com/">
<link rel="dns-prefetch" href="https://www.google.com/">

<!-- Mirrored from www.papstream.net/films/madame.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Apr 2018 12:12:25 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Madame Streaming VF en Français Gratuit Complet, Regarder, Voir le film Madame en streaming vf</title>
<meta name="description" content="Durée : 1h30min, Film : France, Réalisé en 2017, par : Amanda Sthers, Avec Harvey Keitel, Michael Smiley, Rossy de Palma, Tom Hughes, Toni Collette Synopsis : Anne et Bob, un couple d’américains" />
<meta name="keywords" content="France, Drame, Comédie, VF, Harvey Keitel, Michael Smiley, Rossy de Palma, Tom Hughes, Toni Collette, Amanda Sthers, , Madame, DVDRip, 1h30min, 2017" />
<link rel="canonical" href="http://www.papstream.net/films/madame.html" />
<meta property="og:image" content="http://www.papstream.net/poster/film/2017-12/madame-3790.jpg" />
<meta property="og:title" content="Madame Streaming VF" />
<meta property="og:url" content="http://www.papstream.net/films/madame.html" />
<meta property="og:description" content="Durée : 1h30min, Film : France, Réalisé en 2017, par : Amanda Sthers, Avec Harvey Keitel, Michael Smiley, Rossy de Palma, Tom Hughes, Toni Collette Synopsis : Anne et Bob, un couple d’américains" />
<meta property="og:type" content="http://www.papstream.net/films/video.movie" />
...
<link rel="alternate" type="application/rss+xml" title="Film streaming gratuit HD en VF et VOSTFR, série et manga streaming" href="http://www.papstream.net/films/rss.xml" />
...
<![endif]--><script type="text/javascript">var $li = $('#player_v_DIV_2 li').click(function() {  $li.removeClass('selected');  $(this).parent().css('background', 'url(/images/r-srchbg_white.png) no-repeat');  });    var siteurl = "http://www.papstream.net/";  function loadit( element){var videoplay = document.getElementById('videoplay');videoplay.src=element.rel;var navt=document.getElementById('navt').getElementsByTagName("a");for (var i=0; i < navt.length; i++){if(navt[i].rel == element.rel) navt[i].className="active2";else navt[i].className="noavtive";}}  function startit(){var navt=document.getElementById('navt').getElementsByTagName("a");var videoplay = document.getElementById('videoplay');videoplay.src = navt[0].rel;} window.onload=startit;</script><script src="http://www.papstream.net/templates/default/js/jquery-1.10.2.js"></script>
</head> <body>
<div id="fb-root"></div>
...
<li><a href="../../logout.php" title="Inscription sur le site" class="nav-login-user radius-5">LOG OUT</a></li>
</ul></div>
...
<ul class="nav-info">
<li data-toggle="tooltip" data-placement="bottom" data-original-title="Demande D'ajoutés Un Video" title="Demande D'ajoutés Un Video">
<a href="../demande.php">
<i class="fa fa-film"></i><span>Demande D'ajoutés Un Video</span>
</a>
</li>
<li data-toggle="tooltip" data-placement="bottom" data-original-title="Contact" title="Contact">
<a href="../contact.php">
...
<div class="row">
<div class="speedbar">
<span id="dle-speedbar"><span itemscope="" itemtype="http://data-vocabulary.org/Breadcrumb"><a href="../index.php" itemprop="url"><span itemprop="title">Papstream</span></a></span> » <span itemscope="" itemtype="http://data-vocabulary.org/Breadcrumb"><a href="../serie.php" itemprop="url"><span itemprop="title"><?php echo $dataa['NOM_CATEGORIE'] ; ?></span></a></span> » <?php echo $dataa['TITRE'] ; ?></span>
</div>
<div id="dle-content"><div class="fullstory" style="padding-bottom: 138px;">
<h1 class="fstory-h1">
<span class="fstory-favorites" title="Ajouter aux favoris">
<a href="https://www.google.fr/#q=Madame+en+streaming" target="_blank"><img src="http://www.papstream.net/img/google.png" alt="google"></a>
</span>
<b>
<span class="masha_index masha_index1" rel="1"></span>
<?php echo $dataa['TITRE'] ; ?> 
<a href="#"><?php echo $dataa['ANNE_PRODUCTION'] ; ?> </a> en streaming
</b>
</h1><script language="javascript" type="text/javascript" src="http://www.papstream.net/js/wra.js"></script><div id="fstory-film" class="margin-b40 block-p">
<div class="row">
<div class="col-sm-4 col-xs-12 fstory-poster-in">
<div class="fstory-poster">
<img src="<?php echo $dataa['LIEN_IMAGE'] ; ?> " alt=" streaming français" title="<?php echo $dataa['TITRE'] ; ?> streaming français" style="width: 238; height: 320;">
<!-- ********************************************************* -->
   <input type="hidden" name="id_video" value="<?php echo "".$id_video."" ?>"></input>


<!--*******************************************************************- -->
</div>
<div class="clearfix"></div><button type="button" class="btn btn-trailer" data-toggle="modal" data-target="#trailer">
<i class="fa fa-video-camera"></i><b><span class="masha_index masha_index3" rel="3"></span>Bande Annonce</b>
</button>
<div class="modal fade" id="trailer" tabindex="-1" role="dialog" aria-hidden="true" style="display: none;">
<div class="modal-dialog">
<div class="modal-content">
<button type="button" class="close" data-dismiss="modal" aria-label="Close">
<span aria-hidden="true"><span class="masha_index masha_index4" rel="4"></span>×</span>
</button>
<div class="modal-body">
<div class="video-responsive">
<iframe frameborder="0" data-src="<?php echo $dataa['LIEN_VIDEO'] ; ?>" scrolling="no" allowfullscreen="true"></iframe>
</div>
</div>
</div>
</div>
</div>
<div class="rating-sys 8767">
...
<div class="finfo-text"><b><span class="masha_index masha_index5" rel="5"></span><?php echo $dataa['TITRE'] ; ?> - Papstream</b> </div>
</div>
</div>
<div class="finfo">
<span class="finfo-line"></span>
...
<span class="finfo-line"></span>
<div class="finfo-block">
<div class="finfo-title"><span class="masha_index masha_index13" rel="13"></span>Année Production :</div>
<div class="finfo-text"><span class="masha_index masha_index14" rel="14"></span><a href="#" title="film 2017"><?php echo $dataa['ANNE_PRODUCTION'] ; ?></a>  </div>
</div>
</div>
<div class="finfo">
<span class="finfo-line"></span>
...
<div class="finfo-text"><a href="#C"><span class="masha_index masha_index16" rel="16"></span><?php echo $dataa['NOM_CATEGORIE'] ; ?></a> / <a href="#G" title="Plus de films du genre Drame"><?php echo $dataa['NOM_GENRE'] ; ?></a> </div>
</div>
</div>
<div class="finfo">
<span class="finfo-line"></span>
...
<div class="finfo-text"><span class="masha_index masha_index18" rel="18"></span><a  title="film réalisée par Amanda Sthers"><?php echo $dataa['REALSATEUR'] ; ?></a>, </div>
</div>
</div>
<div class="finfo">
<span class="finfo-line"></span>
...
<div class="finfo-text"><span class="masha_index masha_index20" rel="20"></span><a  title="film Harvey Keitel en streaming"><?php echo $dataa['ACTEUR'] ; ?></a>, </div>
</div>
</div>
<div class="finfo">
<span class="finfo-line"></span>
...
<h2>Description <?php echo $dataa['TITRE'] ; ?> <a href="#c"><?php echo $dataa['ANNE_PRODUCTION'] ; ?></a> :</h2>
<?php echo $dataa['DESCRIPTION'] ; ?>
<div class="clearfix"></div></div><script type="text/javascript" src="https://adtag.cc/_tags/jstags.js?s=fr/papstream/vp"></script><br /><div id="full-video"><ul id="navt" class="nav-tabs block-p" role="tablist"></ul>
<div>
...
<div class="wprp_form" id="wprpform8767" style="display: none;background: rgb(36, 48, 61) none repeat scroll 0% 0% / auto padding-box border-box;border: 1px solid rgb(34, 41, 51);">
<form action="#" method="post" enctype="text/plain" onsubmit="return wprp_report(this,'film');">
<table style="width: 100%;">
<tbody style="width: 100%;">
<tr style="width: 100%;">
<td style="text-align: -webkit-right;vertical-align: middle;padding: 0px;">
<label style="color: #CDDC39;">
Signaler comme:
</label>
</td>
<td>
<select name="report_as" style="color: rgb(0, 0, 0);margin: 12px 9px 9px 8px;padding: 5px;"><option value="Lien Mort">Lien Mort</option> <option value="Son décalé">Son décalé</option> <option value="Mauvaise Langue">Mauvaise Langue</option> <option value="Ce lien ne correspond pas a la fiche">Ce lien ne correspond pas a la fiche</option> <option value="Autres">Autres</option></select>
<input type="hidden" value="8767" name="post">
<input type="hidden" name="_wpnonce" value="Madame">
<input type="hidden" name="_post_url" value="madame">
<input name="do_report" type="submit" value="Signaler" id="signaler_INPUT_25" style="padding: 5px;color: black;"></td>
</tr>
</table>
</form>
</div>
...
<div class="clearfix"></div>
</div><div class="responsive-ad"><script type="text/javascript" src="https://adtag.cc/_tags/jstags.js?s=fr/papstream/72890_up"></script></div><br />
<div id="full-video">
<div id="DIV_1">
<div id="DIV_2">
<div id="DIV_3">Choisir une saison
</div>
</div>
<br id="BR_7" />
<?php
...
?>
<br />
<div class="responsive-ad"><script type="text/javascript" src="https://adtag.cc/_tags/jstags.js?s=fr/papstream/72890_up"></script></div><br /><div id="DIV_50">
...
</span></li></ul><br /><script type="text/javascript" src="https://adtag.cc/_tags/jstags.js?s=fr/papstream/72890_down"></script><br /></div></div>
<?php
}}
?>
