...
$sq="INSERT INTO demande VALUES('','$titre','$orgine_video','$realisateur','$acteur','$duree','$date_sortie','$annee_production','$description','$lien_image','$lien_video','$genre','$categorie')";
$requet=mysqli_query($conn,$sq);
if($requet)
...
<div class="responsive-ad"><script type="text/javascript" src="../adtag.cc/_tags/jstagsf7b8.html?s=fr/papstream/72890_home"></script></div><br /><div id="mainbar" class="container margin-b40"><div class="row">
<div class="col-md-9 col-xs-12">
<div class="row">
<div class="speedbar">
<span id="dle-speedbar"><span itemscope="" itemtype="http://data-vocabulary.org/Breadcrumb">
<a href="index.html" itemprop="url"><span itemprop="title">Papstream</span></a></span> » Demande d'ajouter un video</span>
</div>

<div id="dle-content"><form method="post" id="sendmail" name="sendmail" action="">
<div id="page-input">
<h1 class="h-page">Demande d'ajouter un video</h1>
...
<div class="igroup">
<span class="igroup-span">Nom Video  : </span>
<input type="text" maxlength="35" name="titre" class="igroup-input" placeholder="Nom video">
</div>
<div class="igroup">
<span class="igroup-span">Orgine Video: </span>
<input type="text" maxlength="35" name="orgine_video" class="igroup-input" placeholder="Orgine Video">
</div>
<div class="igroup">
<span class="igroup-span"> Realisateur: </span>
<input type="text" maxlength="35" name="realisateur" class="igroup-input" placeholder="Nom realisateur">
</div>
<div class="igroup">
<span class="igroup-span">Nom Acteur: </span>
<input type="text" maxlength="35" name="acteur" class="igroup-input" placeholder="Nom acteurs">
</div>
<div class="igroup">
<label class="igroup-span">Duree    :    </label>
<input type="text" maxlength="35" name="duree" class="igroup-input" placeholder="Durée du video">
</div>
<div class="igroup">
<span class="igroup-span">Date sortie: </span>
<input type="date" maxlength="35" name="date_sortie" class="igroup-input" placeholder="Date sortie">
</div>
<div class="igroup">
<span class="igroup-span">Anne prod: </span>
<input type="text" maxlength="35" name="annee_production" class="igroup-input" placeholder="Annee production">
</div>
<div class="igroup">
<span class="igroup-span">Description: </span>
<input type="text" maxlength="35" name="description" class="igroup-input" placeholder="Description video">
</div>
<div class="igroup">
<span class="igroup-span">Lien Image: </span>
<input type="text" maxlength="35" name="lien_image" class="igroup-input" placeholder="Lien image ">
</div>


<div class="igroup" >
<span class="igroup-span" >Lien Video: </span>
<input type="text" maxlength="45" name="lien_video" class="igroup-input" placeholder="Lien video">
</div>
...
<?php
                ...
                while($data12=mysqli_fetch_assoc($sql12))
                {
              ?>
<input type="radio" name="categorie"  value="<?php echo $data12['ID_CATEGORIE']; ?>" >
...
<?php
               $sql11=mysqli_query($conn,"SELECT * from genre");
...
<button name="submit" class="btn btn" type="submit">Envoyer</button>
</div>
</div>
</div>
<input name="submitt" type="hidden" value="send">
