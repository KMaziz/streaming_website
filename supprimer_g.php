...
if (isset($_GET['id']))
{
  ...
  $delete="DELETE FROM genre WHERE ID_GENRE=".$id;
  $res=mysqli_query($conn,$delete);
  if($res)
    echo "la compte est supprimer avec succes";
  else
    echo "echec du suprrission";
}
?>
<html lang="en">
  ...
  <tbody>
                <tr>
                 ...
                 <td><?php echo $data['NOM_GENRE']; ?></td>
                  ...
                  <?php
                 $sql1=mysqli_query($conn,"SELECT * from categorie  where ID_CATEGORIE=".$data['ID_GENRE']);

                if ($ligne=mysqli_fetch_array($sql1,MYSQLI_NUM))
                {
                  ?>
               ...
               ?>
                    ...
                    <?php
                 $sql11=mysqli_query($conn,"SELECT NOM_SOUS_CA from sous_categorie  where ID_SOUS_CA=".$data['ID_GENRE']);

                if ($ligne1=mysqli_fetch_assoc($sql11))
                {
                  ?>
                   <td><?php echo  $ligne1['NOM_SOUS_CA'] ;?></td>
               ...
               ?>
                  <td><?php echo "<a href='supprimer_g.php?id=".$data['ID_GENRE']."'> supprimer </a> " ; ?></td>
                </tr>
