...
$NOM_SOUS_CA=$_POST['NOM_SOUS_CA'];
$categorie=$_POST['categorie'];
$id=$_POST['id'];


 $sql = "UPDATE sous_categorie
            SET     NOM_SOUS_CA      = '$NOM_SOUS_CA',
    ...
    <div class="container-fluid">
      ...
      <?php
       if(mysqli_query($conn,$sql))
          ...
          <?php echo "modification avec succes"; ?></div>
 			 <?php
		    }
		else
		{
		...
		<div class="alert alert-warning alert-dismissible">
          <?php echo "echec de modification"; ?> </div>
            			<?php
  			}
