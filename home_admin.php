    ...
    <div class="container-fluid">
      ...
      <!--   <div class="wrapper">
            <img src="p.jpg">
              <div class="overlay">
                <div class="content">
                 <p> the title <a href="#">read more </a></p>
                  </div>
                  </div>
                  </div>
                  </br>-->
...
if($ligne[12]==$i)
{
 echo "video.php?id=".$ligne[0];
 }
 else
 {
 echo "video_serie.php?id=".$ligne[0];
 }
  ?>" class="textOverImage" style="background-image:url(<?php echo $ligne[9]; ?>)" data-title="<?php echo $ligne[1]; ?>" data-text="<?php echo $ligne[8]; ?>
  ">
</a>
