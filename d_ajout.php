...
$sqq="DELETE FROM demande where ID_DEMANDE=".$id; 
...
{     ?>
  <tbody>
                <tr>
                  ...
                  <td><a href=<?php echo "d_ajout_con.php?id_demande=".$data['ID_DEMANDE']; ?> class="btn btn-primary">Consulter</a>
                      <a href=<?php echo "d_ajout.php?id=".$data['ID_DEMANDE']; ?> class="btn btn-primary">Supprimer</a></td>
