...
$sq="INSERT INTO video VALUES('','$titre','$orgine_video','$realisateur','$acteur','$duree','$date_sortie','$annee_production','$description','$lien_image','$lien_video','$genre','$categorie','')";
...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <div class="container">
    <div class="card card-register mx-auto mt-5">
      ...
      <div class="card-body">
        <form method="POST" action="ajouter_v.php">
