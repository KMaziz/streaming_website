...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <div class="content-wrapper">
    ...
    <form  method="POST" action="mod1_sc.php">
      <div class="card-body">
...
// lancement de la requete
  ...
  $sql = "SELECT * FROM sous_categorie where 
     ID_SOUS_CA = ".$id ;
...
<input type="hidden" name="id" value="<?php echo($id) ;?>">
  ...
  <tbody>
                <tr>
                  ...
                  <td><input type="text" name="NOM_SOUS_CA" value="<?php echo($data->NOM_SOUS_CA); ?>"></td>
                  <td><?php
  ...
  //affichage des données:
     ...
     ?>
                  ...
                  <input type="radio" name="categorie" selected="selected" value="<?php echo ($data1->ID_CATEGORIE); ?>"><?php echo ($data1->NOM_CATEGORIE); ?>
<?php
                    }
                  ?>
                  </td>                   
