...
if (isset($_GET['id']))
{
  ...
  $delete="DELETE FROM sous_categorie WHERE ID_SOUS_CA=".$id;
...
{     ?>
  <tbody>
                <tr>
                  <td><?php echo $data['ID_SOUS_CA']; ?></td>
                 <td><?php echo $data['NOM_SOUS_CA']; ?></td>

                  <?php
                 $sql1=mysqli_query($conn,"SELECT * from categorie  where ID_CATEGORIE=".$data['ID_CATEGORIE']);
               ...
               ?>
                  ...
                  <td><?php echo "<a href='supprimer_sc.php?id=".$data['ID_SOUS_CA']."'> supprimer </a> " ; ?></td>
                </tr>
