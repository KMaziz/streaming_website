...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <?php
        ...
        {         $ID_GENRE=$_GET['id'];
                  ...
                  $sq1="SELECT * FROM video WHERE ID_GENRE='$ID_GENRE' and ID_CATEGORIE<>'1' ";
                  ...
                  ?>
<div class="container-fluid">
<a href="<?php echo "video.php?id=".$ligne['ID_VIDEO']; ?>" class="textOverImage" style="background-image:url(<?php echo $ligne['LIEN_IMAGE']; ?>)" data-title="<?php echo $ligne['TITRE']; ?>" data-text="<?php echo $ligne['DESCRIPTION']; ?>
  ">
</a>
