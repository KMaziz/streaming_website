...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <div class="content-wrapper">
    ...
    <form  method="POST" action="mod1_g.php">
      <div class="card-body">
...
<input type="hidden" name="id" value="<?php echo($id) ;?>">
  ...
  <tbody>
                <tr>
                  ...
                  <td><input type="text" name="NOM_GENRE" value="<?php echo($data->NOM_GENRE); ?>"></td>
                  <td><?php
                  $sql1 = "SELECT * FROM categorie  ";
 
  //exécution de la requête:
      $requete1 = mysqli_query($conn,$sql1) ;
 
  //affichage des données:
     while ( $data1 = mysqli_fetch_object( $requete1 ) )
     {
     ?>

                  <input type="radio" name="NOM_CATEGORIE" selected="selected" value="<?php echo ($data1->ID_CATEGORIE); ?>"><?php echo ($data1->NOM_CATEGORIE); ?>
<?php
                    }
                  ?>
                  </td>
                  <td>
                  <?php
                  $sql11 = "SELECT * FROM sous_categorie ";
 
  //exécution de la requête:
      $requete11 = mysqli_query($conn,$sql11) ;
 
  //affichage des données:
     while ( $data11 = mysqli_fetch_object( $requete11 ) )
     {
     ?>

                  <input type="radio" name="NOM_SOUS_CA" selected="selected" value="<?php echo ($data11->ID_SOUS_CA); ?>"><?php echo ($data11->NOM_SOUS_CA); ?>
<?php
                    }
                  ?></td>
