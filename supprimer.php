...
if (isset($_GET['id']))
{
  ...
  $delete="DELETE FROM utilisateur WHERE ID_UTILI=".$id;
...
{     ?>
  <tbody>
                <tr>
                  ...
                  <?php
                 $sql1=mysqli_query($conn,"SELECT * from role  where ID_ROLE=".$data[1]);
               ...
               ?>
                  ...
                  <td><?php echo "<a href='supprimer.php?id=".$data[0]."'> supprimer </a> " ; ?></td>
                </tr>
