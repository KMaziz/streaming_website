...
{
$nom_genre=htmlentities(trim($_POST['nom_genre']));
$categorie=htmlentities(trim($_POST['categorie']));
$sous_categorie=htmlentities(trim($_POST['sous_categorie']));

if($nom_genre&&$categorie&&$sous_categorie)
    {
        

$sql="INSERT INTO genre VALUES('','$nom_genre','$categorie','$sous_categorie')";
      ...
      <div class="card-body">
        <form method="POST" action="">
           <div class="form-group">
            <div class="form-row">
                <label for="exampleInputName">Nom Genre</label>
                <input class="form-control" id="exampleInputName" type="text" name="nom_genre" aria-describedby="nameHelp" placeholder="Enter Nom Genre">
              </div>
          </div>
         <div class="form-row">
              <div class="col-md-6">
         ...
         <div class="form-group">
              <div class="col-md-12">
                            <label >Choisir Une Sous Categorie :</label></br>

                 <?php
                $sql1=mysqli_query($conn,"SELECT * from sous_categorie");

                while($data=mysqli_fetch_array($sql1,MYSQLI_NUM))
                {
              ?>
                <input  type="radio" name="sous_categorie" value="<?php echo $data[0]; ?>">
                <label ><?php echo $data[1]; ?></label>
                <?php
               }
               ?>
